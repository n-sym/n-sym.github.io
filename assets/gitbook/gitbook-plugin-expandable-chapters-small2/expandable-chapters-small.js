require(['gitbook', 'jQuery'], function (gitbook, $) {
    var PLUGIN = 'expandable-chapter-small2',
        ...
        ARTICLE_CHILDREN = 'ul',
        TRIGGER_TEMPLATE = '<i class="exc-trigger"></i><span class="material-symbols-rounded">chevron_forward</span>',
    ...
    var init = function () {
        ...
        if (activeChapter.length > 0 && activeChapter.find(ARTICLE_CHILDREN).length > 0) {
